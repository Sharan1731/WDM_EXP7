...
for i in range(4):
    print(f"Node {i}: Authority Score = {authority[i]:.4f}, "
...
<img width="462" height="232" alt="image" src="https://github.com/user-attachments/assets/c07592bd-8eec-4ab5-b174-f34b4d9716b4" />

<img width="895" height="487" alt="image" src="https://github.com/user-attachments/assets/077fbc43-1a1e-4f81-aab7-bdff03215fed" />



### Result:

The HITS algorithm successfully calculates the Authority and Hub scores for all four nodes and displays them using a bar chart.
